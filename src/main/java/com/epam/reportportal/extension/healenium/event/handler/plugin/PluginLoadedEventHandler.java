package com.epam.reportportal.extension.healenium.event.handler.plugin;

import com.epam.reportportal.extension.event.PluginEvent;
import com.epam.reportportal.extension.healenium.HealeniumPluginExtension;
    ...
    private void loadBinaryDataInfo(IntegrationType integrationType) {
        ...
        if (ofNullable(details.get(BINARY_DATA)).isEmpty()) {
            try (InputStream propertiesStream = Files.newInputStream(Paths.get(resourcesDir,
                    HealeniumPluginExtension.BINARY_DATA_PROPERTIES_FILE_ID
            ))) {
